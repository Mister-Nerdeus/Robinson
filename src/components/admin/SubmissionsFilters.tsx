...
export function SubmissionsFilters({ selectedType = "", dateFrom = "", dateTo = "" }: Props) {
  return (
    <form className="grid gap-3 rounded-md border border-[#d8c1c1] bg-[#fff7f6] p-4 md:grid-cols-[1fr,1fr,1fr,auto] md:items-end" method="get">
